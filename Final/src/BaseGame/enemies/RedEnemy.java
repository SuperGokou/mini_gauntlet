...
public class RedEnemy extends BaseEnemy {
  ...
  public RedEnemy(float x, float y) {
    super(x, y);
    // Add movement
    addEnemyAnimation("MoveSouth", new Animation(ResourceManager.getSpriteSheet(BaseGame.RED_ENEMY_RSC,
        32, 32), 0, 0, 3, 0, true, 100, true));
    addEnemyAnimation("MoveWest", new Animation(ResourceManager.getSpriteSheet(BaseGame.RED_ENEMY_RSC,
        32, 32), 0, 1, 3, 1, true, 100, true));
    addEnemyAnimation("MoveNorth", new Animation(ResourceManager.getSpriteSheet(BaseGame.RED_ENEMY_RSC,
        32, 32), 0, 2, 3, 2, true, 100, true));
    addEnemyAnimation("MoveEast", new Animation(ResourceManager.getSpriteSheet(BaseGame.RED_ENEMY_RSC,
